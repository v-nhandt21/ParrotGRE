export const writingTask1Types = [
  ...
  },
  {
    ...
    sampleAnswer: {
      ...
      vi: "Biểu đồ cột so sánh tỷ lệ việc làm của nam và nữ tại sáu quốc gia châu Âu năm 2015.\n\nNhìn chung, tỷ lệ việc làm của nam cao hơn nữ ở mọi quốc gia được hiển thị, mặc dù khoảng cách này biến động đáng kể. Thụy Sĩ ghi nhận số liệu việc làm cao nhất cho cả hai giới.\n\nThụy Điển có tỷ lệ việc làm nữ cao nhất ở mức 74%, tiếp theo là Thụy Sĩ ở mức 73% và Đức ở mức 67%. Ngược lại, Ý có tỷ lệ phụ nữ có việc làm thấp nhất chỉ 47%, với Tây Ban Nha cũng cho thấy con số tương đối thấp là 52%.\n\nVề việc làm của nam, Thụy Sĩ ghi nhận tỷ lệ cao nhất ở mức 84%, với Đức (80%) và Thụy Điển (79%) cũng đạt kết quả tốt. Ý một lần nữa có tỷ lệ việc làm nam thấp nhất ở mức 63%, mặc dù vẫn vượt tỷ lệ việc làm nữ ở tất cả các quốc gia khác. Đáng chú ý, khoảng cách việc làm theo giới rõ rệt nhất ở Ý (16 điểm phần trăm) và nhỏ nhất ở Thụy Điển (5 điểm phần trăm)."
    },
  ...
  },
  {
    ...
    sampleAnswer: {
      ...
      vi: "Các biểu đồ tròn so sánh mô hình chi tiêu hộ gia đình ở Vương quốc Anh vào năm 1980 và 2020.\n\nNhìn chung, nhà ở đại diện cho danh mục chi tiêu lớn nhất duy nhất trong cả hai năm, trong khi tỷ lệ chi cho thực phẩm và giải trí thay đổi đáng kể nhất trong giai đoạn 40 năm.\n\nNăm 1980, nhà ở chiếm tỷ trọng lớn nhất ở mức 35%, tiếp theo là thực phẩm ở mức 28% và phương tiện đi lại ở mức 15%. Giải trí và tiêu khiển chỉ chiếm 10% ngân sách hộ gia đình, trong khi các chi phí khác chiếm 12% còn lại.\n\nĐến năm 2020, sự phân bổ đã thay đổi đáng kể. Nhà ở vẫn chiếm ưu thế, tăng nhẹ lên 37%, trong khi tỷ lệ chi cho thực phẩm giảm đáng kể xuống chỉ còn 17% — tức giảm 11 điểm phần trăm. Ngược lại, chi tiêu cho giải trí tăng mạnh lên 22%, phản ánh sự thay đổi ưu tiên của người tiêu dùng. Tỷ trọng phương tiện đi lại vẫn tương đối ổn định ở mức 14%, trong khi các khoản chi khác giảm nhẹ xuống 10%."
    },
  ...
  },
  {
    ...
    sampleAnswer: {
      ...
      vi: "Bảng trình bày chi phí sinh hoạt trung bình hàng tháng ở năm thành phố quốc tế năm 2023, được chia nhỏ thành các danh mục thuê nhà, thực phẩm, giao thông và giải trí.\n\nNhìn chung, Singapore có tổng chi phí sinh hoạt cao nhất ở mức 3.200 đô la mỗi tháng, trong khi Bangkok cung cấp lối sống phải chăng nhất ở mức 1.100 đô la. Sự chênh lệch lớn nhất giữa các thành phố được ghi nhận ở chi phí thuê nhà.\n\nVề chỗ ở, Singapore đắt đỏ nhất với tiền thuê nhà trung bình hàng tháng là 1.800 đô la, so với chỉ 350 đô la ở Bangkok — chênh lệch hơn năm lần. London và Sydney đều ghi nhận chi phí thuê nhà cao lần lượt là 1.600 và 1.500 đô la, trong khi New York ở mức 1.700 đô la.\n\nChi phí thực phẩm và giao thông cho thấy phạm vi thu hẹp hơn. Singapore tiếp tục dẫn đầu về thực phẩm ở mức 500 đô la mỗi tháng, tiếp theo là London ở mức 480 đô la. Bangkok rẻ nhất cho cả thực phẩm (200 đô la) và giao thông (80 đô la), đóng góp đáng kể vào lợi thế chi phí sinh hoạt thấp tổng thể."
    },
  ...
  },
  {
    ...
    sampleAnswer: {
      ...
      vi: "Sơ đồ minh họa quy trình bảy giai đoạn mà qua đó giấy đã qua sử dụng được thu gom, xử lý và tái chế thành các sản phẩm giấy mới.\n\nNhìn chung, quy trình tái chế là một chuỗi tuyến tính biến đổi giấy thải thành nguyên liệu thô có thể tái sử dụng, cuối cùng sản xuất giấy mới sẵn sàng để phân phối.\n\nQuy trình bắt đầu với việc thu gom giấy thải từ hộ gia đình, văn phòng và thùng tái chế, sau đó được vận chuyển đến cơ sở tái chế. Trong giai đoạn xử lý ban đầu, giấy được phân loại theo loại và chất lượng, sau đó được nghiền nhỏ và trộn với nước và hóa chất trong các thùng lớn để tạo thành hỗn hợp bột giấy lỏng.\n\nBột giấy này sau đó được làm sạch để loại bỏ các tạp chất như mực, ghim và chất kết dính thông qua quá trình lọc và khử mực. Bột giấy đã làm sạch được trải ra màn lưới phẳng, nơi nước thoát đi và các sợi liên kết với nhau tạo thành tờ giấy. Các tờ giấy này được ép và sấy khô bằng con lăn gia nhiệt, tạo ra giấy phẳng mịn. Trong giai đoạn cuối, giấy tái chế được cuộn thành các cuộn lớn và cắt theo kích cỡ tiêu chuẩn trước khi được phân phối đến người tiêu dùng hoặc nhà sản xuất."
    },
  ...
  },
  {
    ...
    sampleAnswer: {
      ...
      vi: "Hai bản đồ minh họa sự phát triển của thị trấn Riverside từ năm 1970 đến ngày nay, cho thấy sự biến đổi đô thị đáng kể trong 50 năm qua.\n\nNhìn chung, Riverside đã trải qua sự mở rộng và hiện đại hóa đáng kể, với việc thay thế đất công nghiệp và nông nghiệp bằng các khu dân cư và thương mại, mặc dù trung tâm thị trấn ban đầu phần lớn được bảo tồn.\n\nNăm 1970, Riverside là khu dân cư khiêm tốn tập trung quanh phố chính chạy theo hướng đông-tây, với chợ ở phía bắc và công viên nhỏ ở phía nam. Đất nông nghiệp chiếm vùng ngoại ô phía đông, trong khi nhà máy và khu công nghiệp chiếm ưu thế ở ngoại ô phía tây.\n\nĐến ngày nay, những thay đổi rất đáng kể. Đất nông nghiệp phía đông được thay bằng khu dân cư lớn, trong khi khu công nghiệp phía tây bị phá dỡ và chuyển thành trung tâm mua sắm hiện đại. Công viên được mở rộng đáng kể và một trường học mới được xây dựng ở phía nam phố chính. Con đường chính qua thị trấn được mở rộng và một vòng xuyến được đặt tại lối vào phía đông. Tuy nhiên, khu chợ phía bắc vẫn hầu như không thay đổi."
    },
